...
5. **Configures Environment Variables**:
   ...
   - `CFN_TEMPLATE_S3_BUCKET_NAME`: Base name for the CloudFormation template S3 bucket, formatted as `${env.CFN_TEMPLATE_S3_BUCKET_NAME}-${env.AWS_ACCOUNT_ID}-${env.AWS_REGION}`
